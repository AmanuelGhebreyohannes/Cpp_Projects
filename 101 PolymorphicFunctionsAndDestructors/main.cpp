...
class Base
{
    public:
        Base()
        {
            ...
            //this->setup(); //avoid calling virtual functions inside constructors and destructors
        }
        virtual ~Base()
        {
            //this->clean_up(); //avoid calling virtual functions inside constructors and destructors
